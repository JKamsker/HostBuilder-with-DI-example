...
/// </summary>
public static class BetterCommandLineConfigurationExtensions
{
    /// <summary>
    ...
    ///   </code>
    /// </example>
    public static IConfigurationBuilder AddBetterCommandLine(this IConfigurationBuilder configurationBuilder, string[] args)
    {
        return configurationBuilder.AddBetterCommandLine(args, switchMappings: null);
    }
    ...
    ///   </code>
    /// </example>
    public static IConfigurationBuilder AddBetterCommandLine(
        this IConfigurationBuilder configurationBuilder,
        string[] args,
        IDictionary<string, string> switchMappings)
    {
        configurationBuilder.Add(new BetterCommandLineConfigurationSource { Args = args, SwitchMappings = switchMappings });
    ...
    /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
    public static IConfigurationBuilder AddBetterCommandLine(this IConfigurationBuilder builder, Action<BetterCommandLineConfigurationSource> configureSource)
...
/// </summary>
public class BetterCommandLineConfigurationSource : IConfigurationSource
{
    /// <summary>
    ...
    /// <summary>
    /// Builds the <see cref="BetterCommandLineConfigurationProvider"/> for this source.
    /// </summary>
    /// <param name="builder">The <see cref="IConfigurationBuilder"/>.</param>
    /// <returns>A <see cref="BetterCommandLineConfigurationProvider"/></returns>
    public IConfigurationProvider Build(IConfigurationBuilder builder)
    {
        return new BetterCommandLineConfigurationProvider(Args, SwitchMappings);
    }
}


public class BetterCommandLineConfigurationProvider : Microsoft.Extensions.Configuration.CommandLine.CommandLineConfigurationProvider
{
    public BetterCommandLineConfigurationProvider(IEnumerable<string> args, IDictionary<string, string> switchMappings = null) : base(args, switchMappings)
    {
    }
    ...
    public override void Load()
    {
        ...
        foreach (var (key, value) in base.Data)
        {
